...
//		File : 파일정보를 담는 클래스 (활용도 제일 높음)
//		파일의 경로, 크기 등 정보를 확인하거나 파일을 생성할 수 있음
		
//		newFile.txt와 연결된 클래스 생성
		File file = new File("C:\\data_b\\java-workspace\\newFile.txt");
...
//		System.out.println(file.canWrite());	//쓸 수있는지
		
//		파일삭제
		file.delete();
		
		File dir = new File("C:\\data_b\\java-workspace");
